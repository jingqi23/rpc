...
public class ObjectWriter {
    ...
    public static void writeObject(OutputStream outputStream, Object object, CommonSerializer serializer) throws IOException, IOException {
